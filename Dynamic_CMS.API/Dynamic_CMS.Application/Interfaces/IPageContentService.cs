...
namespace Dynamic_CMS.Application.Interfaces
{
    public interface IPageContentService
    {
        ...
        Task<PageContentDto> SaveByOrgAndMenuItemAsync(Guid organizationId, Guid? menuItemId, Guid? subMenuItemId, CreatePageContentDto dto, string? userName, CancellationToken cancellationToken);
