...
namespace Dynamic_CMS.Infrastructure.Migrations
{
    ...
    [Migration("20260806071546_AddNavbarLayoutToOrganization")]
    partial class AddNavbarLayoutToOrganization
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dynamic_CMS.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<string>("NavbarLayout")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dynamic_CMS.Domain.Entities.PageContent", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "SubMenuItemId")
                        .IsUnique()
                        .HasFilter("[SubMenuItemId] IS NOT NULL");
            ...
            modelBuilder.Entity("Dynamic_CMS.Domain.Entities.PageContent", b =>
                {
                    ...
                    b.HasOne("Dynamic_CMS.Domain.Entities.SubMenuItem", "SubMenuItem")
                        .WithMany()
