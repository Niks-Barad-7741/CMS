    ...
    <div class="min-h-screen flex transition-colors duration-300"
      ...
      <main class="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header class="h-16 flex items-center justify-between px-6 sticky top-0 z-10 shrink-0 backdrop-blur-md transition-all"
          ...
          <div class="flex items-center gap-3">
            <!-- Notifications -->
            <button class="relative p-2 rounded-xl transition-all"
                    style="color:var(--text-muted); background:var(--bg-base);"
                    onmouseenter="this.style.color='#6366F1'"
                    onmouseleave="this.style.color=''">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
              </svg>
              <span class="absolute top-1.5 right-1.5 w-2 h-2 bg-rose-500 rounded-full border-2 border-white animate-pulse-dot"></span>
            </button>
